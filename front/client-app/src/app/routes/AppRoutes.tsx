...
// Закомментировано для демонстрации заказчику
...
const DefaultRedirect = () => {
    ...
    // Временно редиректим на страницу "В разработке" вместо реальных страниц
...
export const AppRoutes = () => (
    <Routes>
        ...
        >
            ...
            />
            {/* Все страницы временно заменены на "В разработке" для демонстрации заказчику */}
            <Route path="dashboard" element={<UnderDevelopmentPage />} />
            <Route path="calendar" element={<UnderDevelopmentPage />} />
            <Route path="program" element={<UnderDevelopmentPage />} />
            <Route path="metrics" element={<UnderDevelopmentPage />} />
            <Route path="nutrition" element={<UnderDevelopmentPage />} />
            <Route path="profile" element={<UnderDevelopmentPage />} />
            <Route path="profile/edit" element={<UnderDevelopmentPage />} />
            <Route path="settings" element={<UnderDevelopmentPage />} />
            <Route path="trainer/clients" element={<UnderDevelopmentPage />} />
            <Route path="trainer/clients/:clientId" element={<UnderDevelopmentPage />} />
            <Route path="trainer/clients/:clientId/metrics" element={<UnderDevelopmentPage />} />
            <Route path="trainer/clients/:clientId/program" element={<UnderDevelopmentPage />} />
            <Route path="trainer/library" element={<UnderDevelopmentPage />} />
            <Route path="trainer/calendar" element={<UnderDevelopmentPage />} />
            <Route path="trainer/finances" element={<UnderDevelopmentPage />} />
            <Route path="under-development" element={<UnderDevelopmentPage />} />
            
            {/* Закомментированные роуты для будущего использования */}
