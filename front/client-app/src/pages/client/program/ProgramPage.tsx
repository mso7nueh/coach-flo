        ...
        <Stack gap="md">
          ...
          <Group grow>
            ...
            <NumberInput
              ...
              value={exerciseForm.rest ? Number(exerciseForm.rest.replace(/\s*сек\s*/g, '')) || undefined : undefined}
              onChange={(value) => setExerciseForm((state) => ({ ...state, rest: value ? `${value} ${t('program.secondsShort')}` : undefined }))}
              min={0}
